...
- Traces: `packages/databento-lightweight-charts/src/feed/index.ts`, `packages/databento-lightweight-charts/test/unit/feed.test.ts`, `docs/requirements.md`, `DEC-014`, `DEC-015`, `contracts/protocol-v1.md`.
